...
<div class='view'>
    ...
    echo '<div style="width:500px;">
        <button type="button" class="msgBtn" onClick="" style="margin-top:100px;height:50px ;width:120px;">Jouer</button>
        <button type="button" class="msgBtn2" onClick="" style="margin-left: 70px;height:50px ;width:120px;">M\'informer</button>
    </div>';
    echo '</center>'; ?>
